...
public class LCSBacktrackingTest {

    private final LCSAlgorithm algoritmo = new LCSBacktracking();
    ...
    public void testCenario1() {
        ...
        // cobre as variações possíveis que o algoritmo pode encontrar primeiro
        assertTrue(lcs.equals("BCBA") || lcs.equals("BDAB") || lcs.equals("BCAB"), 
